...
func TestPredicates(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			predicate: EditedTextEqual(text),
			update:    telego.Update{EditedMessage: &telego.Message{Text: text}},
			matches:   true,
		},
		{
			name:      "edited_text_equal_not_matches",
			predicate: EditedTextEqual(text),
			update:    telego.Update{EditedMessage: &telego.Message{Text: textLower}},
			matches:   false,
		},
		{
			name:      "edited_text_equal_fold_matches",
			predicate: EditedTextEqualFold(text),
			update:    telego.Update{EditedMessage: &telego.Message{Text: textLower}},
			matches:   true,
		},
		{
			...
			predicate: EditedTextEqualFold(text),
			update:    telego.Update{EditedMessage: &telego.Message{Text: command1}},
			matches:   false,
		},
		{
			name:      "edited_text_contains_matches",
			predicate: EditedTextContains(textPart),
			update:    telego.Update{EditedMessage: &telego.Message{Text: text}},
			matches:   true,
		},
		{
		...
		},
		{
			...
			predicate: EditedTextPrefix(textPrefix),
			update:    telego.Update{EditedMessage: &telego.Message{Text: text}},
			matches:   true,
		},
		{
		...
		},
		{
			...
			predicate: EditedTextSuffix(textSuffix),
			update:    telego.Update{EditedMessage: &telego.Message{Text: text}},
			matches:   true,
		},
		{
