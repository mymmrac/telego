...
// VoiceChatParticipantsInvited - This object represents a service message about new members invited to a
// voice chat.
...
// WithResizeKeyboard adds resize keyboard
func (i *ReplyKeyboardMarkup) WithResizeKeyboard() *ReplyKeyboardMarkup {
	i.ResizeKeyboard = true
	return i
}

// WithInputFieldPlaceholder adds input field placeholder
func (i *ReplyKeyboardMarkup) WithInputFieldPlaceholder(inputFieldPlaceholder string) *ReplyKeyboardMarkup {
	i.InputFieldPlaceholder = inputFieldPlaceholder
	return i
}

// KeyboardButton - This object represents one button of the reply keyboard. For simple text buttons String
// can be used instead of this object to specify text of the button. Optional fields request_contact,
...
// TODO: Make those methods autogenerated

// WithRequestContact adds request contact
func (b KeyboardButton) WithRequestContact() KeyboardButton {
	b.RequestContact = true
	return b
}

// WithRequestLocation adds request location
func (b KeyboardButton) WithRequestLocation() KeyboardButton {
	b.RequestLocation = true
	return b
}

// WithRequestPoll adds request poll
func (b KeyboardButton) WithRequestPoll(requestPoll *KeyboardButtonPollType) KeyboardButton {
...
type InlineKeyboardButton struct {
	...
	// when combined with switch_pm… (https://core.telegram.org/bots/api#answerinlinequery) actions – in this
