...
type Update struct {
	...
	// ManagedBot - Optional. A new bot was created to be managed by the bot or token of a bot was changed
...
// ManagedBotUpdated - This object contains information about the creation or token update of a bot that is
